...
async function signup(userName, password, fullName, friends, imgUrl,notifications, joinedAt, pinnedNotes) {
    ...
    return userService.add({ fullName, password: hash, userName, friends, imgUrl, notifications, joinedAt, pinnedNotes})
}
