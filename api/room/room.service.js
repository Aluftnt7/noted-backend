...
//     console.log('inside service starred pointers:', starredNotes);
//     try {
//         let notesToReturn = [];
//         starredNotes.forEach(async currStarredNote => {
//             const { roomId, noteId } = currStarredNote;
//             let room = await getById({ roomId });
//             let starredNote = room.notes.filter((note) => note._id === noteId)[0];
//             console.log('found note:', starredNote);
//             notesToReturn.push(starredNote);
//         });
